...
importpeopleids = [1058768145722134528]
def botowners(ctx):
...
async def on_ready():
    ...
    for s in bot.guilds:
      print(f'{s} - {s.id}')
    await bot.change_presence(activity=discord.Activity(type=discord.ActivityType.watching, name="Exploiters get banned - Jb9 is cool"))
